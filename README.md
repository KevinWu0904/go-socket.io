...
[![GoDoc](http://godoc.org/github.com/KevinWu0904/go-socket.io?status.svg)](http://godoc.org/github.com/KevinWu0904/go-socket.io) [![Build Status](https://travis-ci.org/googollee/go-socket.io.svg)](https://travis-ci.org/googollee/go-socket.io)
...
```bash
go get github.com/KevinWu0904/go-socket.io
```

Import it with:

```go
import "github.com/KevinWu0904/go-socket.io"
```
...
import (
	...
	"github.com/KevinWu0904/go-socket.io"
)
